    ...
    <div class="container-fluid">
        <div class="row pt-2 pb-2 content-wrapper-header">
            <div>
                ...
                <h3 class="page-title"><i class="icon-basket-loaded icons"></i>افزودن محصولات جدید</h3>
            </div>
            <div>
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="input-1" value="{{old('title')}}" placeholder="عنوان محصول را وارد کنید">
                            </div>
                            <div class="form-group">
                                <label for="content">توضیحات</label>
                                <textarea class="form-control" rows="4" id="content" name="content" placeholder="توضیحات محصول را وارد کنید">{{old('content')}}</textarea>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary px-5 w-100">ثبت محصول</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" onkeyup="numberToword(this)" name="price" class="form-control" value="{{old('price')}}" id="price" placeholder="قیمت اصلی را وارد کنید">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="form-group">
                            <input type="number" name="depot" class="form-control" value="{{old('depot')}}" id="depot" placeholder="تعداد را وارد کنید">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="form-group">
                            <select class="form-control" id="category" name="category" onchange="categorise()" required>
    ...
    <script>
        ...
        function categorise() {
            ...
            $.post(url, data, function (msg) {
                $('select[name=brand]').html('<option>برند را انتخاب کنید</option>'+msg)
            })
        }
    </script>
@endsection
