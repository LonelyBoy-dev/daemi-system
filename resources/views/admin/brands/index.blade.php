    ...
    <div class="container-fluid">
        <div class="row pt-2 pb-2 content-wrapper-header">
            <div>
                ...
                <h3 class="page-title"><i class="icon-tag icons"></i>لیست برندها</h3>
            </div>
            <div class="div-button-top">
               {{-- <button onclick="delete_all_items('{{$table}}')" type="button"
                ...
                <a href="/admin/brands/create" type="button" class="btn btn-success waves-effect waves-light m-1">افزودن
                    برند جدید </a>
