    ...
    <div class="container-fluid">
        <div class="row pt-2 pb-2 content-wrapper-header">
            <div>
                ...
                <h3 class="page-title"><i class="zmdi zmdi-account-box"></i>لیست مشترها</h3>
            </div>
            <div class="div-button-top">
               {{-- <button onclick="delete_all_items('{{$table}}')" type="button"
                ...
                <a href="/admin/members/create" type="button" class="btn btn-success waves-effect waves-light m-1">افزودن
                    مشتری جدید </a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @if ($agent->isMobile())
                            <div class="limiter">
                                <form method="get" action="{{route('brands.index')}}" class="row" style="padding: 0 17px;">
                                    <div style="width: 80%;" class="col-xs-11">
                                        <div class="form-group">
                                            <label for="product_search">جستجو</label>
                                            <input type="text" name="type" class="form-control" id="product_search" value="" placeholder="عنوان برند را وارد کنید">
                                        </div>
                                    </div>
                                    <div class="col-xs-1">
                                            ...
                                            <table>
                                                ...
                                                <tr class="table100-head">
                                                  {{--  <th class="column1" style="background-image: none;">
                                                    ...
                                                    <th class="column3">دسته بندی</th>
                                                    <th class="column4">وضعیت</th>
                                                    <th class="column5">تاریخ ثبت </th>
                                                    <th class="column6">فعالیت ها</th>
                                                </tr>
                                                </thead>
                                                <tbody id="brands">
                                                @foreach($brands as $item)
                                                    ...
                                                    <tr id="item{{$item->id}}" data-page="<?= $pageNum+1?>">
                                                      {{--  <td class="column1">
                                                        ...
                                                        @php $category=\App\Models\Category::find($item->category_id); @endphp
                                                        <td class="column1">
                                                            @if(@$category->title!="")
                                                        ...
                                                        <td class="column1">
                                                            <a href="{{route('brands.edit',$item->id)}}" type="button" class="btn btn-outline-info waves-effect waves-light">  <span>ویرایش</span><i class="icon-note "></i> </a>
                                    ...
                                    @foreach($items as $item)
                                        ...
                                        <tr id="item{{$item->id}}">
                                          {{--  <td>
                                            ...
                                            <td>
                                                <a href="{{route('members.edit',$item->id)}}" type="button" class="btn btn-outline-info waves-effect waves-light">  <span>ویرایش</span><i class="icon-note "></i> </a>
                                                <button onclick="delete_solo_item(this,'{{$item->id}}','{{$table}}')" type="button" class="btn btn-outline-danger waves-effect waves-light">  <span>حذف</span><i class="fa fa fa-trash-o"></i> </button>
                                            </td>
...
@section('script')
    ...
    <script>
        ...
        function paginate(){
            $('.pagination').empty();
            var pageName=$('#brands > tr').attr('data-page');
