    ...
    <div class="card card-authentication1 mx-auto my-5">
        <div class="card-body">
            <div class="card-content p-2">
                ...
                <div class="card-title text-uppercase text-center py-3">ثبت نام</div>
                <form method="POST" action="{{ route('register') }}" autocomplete="off">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputUsername" class="sr-only">Username</label>
                        <div class="position-relative has-icon-left">
                            <input type="text" id="exampleInputUsername"  name="name" class="form-control input-shadow  @error('name') is-invalid @enderror" placeholder="نام را وارد کنید" value="{{ old('name') }}" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword" class="sr-only">Password</label>
                        <div class="position-relative has-icon-left">
                            <input type="password" id="exampleInputPassword" class="form-control input-shadow @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="تکرار رمز عبور را وارد کنید">
                            <div class="form-control-position">
                                <i class="icon-lock"></i>
                            </div>
